...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ __('Olho Gordo - Admin') }}</title>
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('template') }}/imagens/favicon.png">
    <link rel="icon" type="image/png" href="{{ asset('template') }}/imagens/favicon.png">
